...
CylSilo_20150729(:,:,1)=[ [0;nan] , [2797;847] ];
CylSilo_20150729(:,:,2)=[ [22.5;nan] , [2808;1282] ];
CylSilo_20150729(:,:,3)=[ [45;nan] , [2806;1761] ];
CylSilo_20150729(:,:,4)=[ [67.5;nan] , [2791;2193] ];
CylSilo_20150729(:,:,5)=[ [90;nan] , [2762;2498] ];
CylSilo_20150729(:,:,6)=[ [112.5;nan] , [2734;2636] ];
CylSilo_20150729(:,:,7)=[ [135;nan] , [2703;2598] ];
CylSilo_20150729(:,:,8)=[ [157.5;nan] , [2677;2404] ];
CylSilo_20150729(:,:,9)=[ [180;nan] , [2659;2091] ];
CylSilo_20150729(:,:,10)=[ [202.5;nan] , [2650;1705] ];
CylSilo_20150729(:,:,11)=[ [225;nan] , [2652;1296] ];
CylSilo_20150729(:,:,12)=[ [247.5;nan] , [2663;917] ];
CylSilo_20150729(:,:,13)=[ [270;nan] , [2684;613] ];
CylSilo_20150729(:,:,14)=[ [292.5;nan] , [2710;425] ];
CylSilo_20150729(:,:,15)=[ [315;nan] , [2741;390] ];
CylSilo_20150729(:,:,16)=[ [337.5;nan] , [2772;534] ];

input_data=CylSilo_20150729;
