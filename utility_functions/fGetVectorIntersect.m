function [ intersection, deltaZ ] = fGetVectorIntersect( point1, point2, theta1, theta2, geo, plotboolean )
%%% ------------------------------------------------------------------- %%%
...
%
% OUTPUT
% intersection is the average 3D location where the two vectors intersect
%
...
%% Output average intersection point

intersection=transpose((intersection1 + intersection2)./2);
